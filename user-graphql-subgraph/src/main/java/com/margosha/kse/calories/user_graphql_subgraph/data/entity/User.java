package com.margosha.kse.calories.user_graphql_subgraph.data.entity;
...
@Table(name = "users", indexes = {
        ...
        @Index(name = "user_full_name", columnList = "first_name, last_name"),
        @Index(name = "user_phone", columnList = "telephone")
})
@Getter
@Setter
@NoArgsConstructor
