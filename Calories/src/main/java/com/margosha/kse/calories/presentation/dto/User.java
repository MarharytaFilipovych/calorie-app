...
public class User {
    ...
    @DecimalMax(value = "250", message = "Weight cannot exceed 500 kg")
    private Double weight;

    @NotNull(message = "Height is required")
    @DecimalMin(value = "100", message = "Height must be at least 50 cm")
    @DecimalMax(value = "230", message = "Height cannot exceed 250 cm")
    ...
    @DecimalMin(value = "30", message = "Target weight must be at least 20 kg")
    @DecimalMax(value = "120", message = "Target weight cannot exceed 500 kg")
